  ...
  return (
    <div className={styles.container}>
      <section id="definition" className={styles.definition}>
        <h3>워터젯(WaterJet) 공법</h3>
        <p className={styles.description}>
          물을 초고압, 초고속 상태의 제트루로 만들어 이를 해체 대상 구조물에
          분사시킴으로써
          <br />
          콘크리트의 세골작용을 일으켜 콘크리트만을 선택적으로 파괴시킬 수 있는
          획기적인 공법입니다.
        </p>
        <div className={styles["image-desc-container"]}>
          <div>
            <p>
              ...
              <br />
              표면 위에 보강 공사를 시행할 때 보강 콘크리트의 부착력을 증대시킬
              수 있습니다.
            </p>
            <p>
            ...
            <p>
              보수 공법 중 재료에 대한 부분은 상당한 발전과 개발이 이루어졌지만,
              <br />
              가장 중요한 불량한 부분을 제거하는 방법은 여전히 기능공의 판단이나
              능력에 의존하는
              <br />
              낙후된 방식만이 사용되고 있습니다.
            </p>
        ...
        <ol>
          <li>
            <span className={styles.number}>
              ...
              분진과 진동이 없으므로 시끄럽거나 까다로운 작업 조건에 적합합니다.
          </li>
          <li>
            <span className={styles.number}>
              0<em>2</em>
          ...
          <li>
            ...
            표면을 요철 방식으로 제거하므로 보강 콘크리트의 부착력이 증대됩니다.
          </li>
          <li>
            <span className={styles.number}>
              0<em>7</em>
          ...
          <li>
            ...
            파쇄되지 않는 면에 대한 충격이 없어 구조물의 성능을 그대로
            유지하면서 파쇄할 수 있습니다.
          </li>
        </ol>
      </section>
