...
// import truck from "../../../../../public/images/icons/tow-truck.svg";
// import sunRays from "../../../../../public/images/icons/sun-rays.png";
// import corrosive from "../../../../../public/images/icons/corrosive.png";
// import wave from "../../../../../public/images/icons/wave.png";
// import vibration from "../../../../../public/images/icons/vibration.png";
// import acidRain from "../../../../../public/images/icons/acid-rain.png";
      ...
      <section id="waterjet-method" className={styles["waterjet-method"]}>
        ...
        >
          ...
          <p className={styles["list-description"]}>
            교량 상부 구조물은 차량 하중, 날씨 변화, 염분 침투 등 외부 요인으로
            인해 시간이 지남에 따라 열화가 진행됩니다.
            <br />
        ...
        >
          ...
          <ul className={styles.list}>
            ...
            <li className={styles["list-item"]}>
              <div className={styles["list-item-card"]}>
                <div className={styles["list-item-card-inner"]}>
                  <Vibration alt="반복적인 진동" width={42} color={"#F4F4F4"} />
                </div>
              </div>
        ...
        <p className={styles.label}>
          <strong>
            정기적인 점검과 적절한 보수 작업은 교량의 안정성과 수명을 유지하는
            데 필수적입니다.
          </strong>
        </p>
        <p className={styles.label}>
          삼형 건설의 워터젯 기술은 열화된 부분만 선택적으로 제거하여 교량 보강
          및 복구 작업을 효율적으로 지원합니다. <br />
